...
export const profileImages: Array<string> = [summerVibe, cleanVibe, basicVibe, punkVibe]
...
export const gitHubWorks: Array<Work> = [
    {
        ...
        linkList: [
            {
                iconName: "GitHub",
                iconHref: "https://github.com/alkmanistik/alkmanistik.github.io",
                iconSrc: gitHub,
            },
        ],
    },
...
export const mobileWorks: Array<Work> = [
    {
        ...
        linkList: [
            {
                iconName: "GitHub",
                iconHref: "https://github.com/alkmanistik/EnvironmentalProjectForHackaton",
                iconSrc: gitHub,
            },
        ],
    },
    {
        ...
        linkList: [
            ...
            {
                iconName: "RuStore",
                iconHref: "https://www.rustore.ru/catalog/app/com.alkmanistik.diceapp",
                iconSrc: ruStore,
            },
        ],
    },
